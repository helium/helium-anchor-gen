...
* **Contributing Code**: If you have new code or a bug fix, fork this
  ...
  repo](https://github.com/lthiery/helium-anchor-gen). Include a
  write up of the PR with details on what it does.

* **Reporting Bugs**: Open an issue [against this
  repo](https://github.com/lthiery/helium-anchor-gen/issues) with as much
...
Above all, thank you for taking the time to be a part of our community.
